 ...
 */
package xyz.nhatbao.ninetour.vnpay;
...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/9tour/tour/booking/process";
    public static String vnp_TmnCode = "154MSF4E";
    public static String vnp_HashSecret = "YQMUZDAMJAQVQZOYQFIWXGOAMKOKTPLF";
    ...
    public static String hashAllFields(Map fields) throws UnsupportedEncodingException {
        ...
        sb.append(xyz.nhatbao.ninetour.vnpay.Config.vnp_HashSecret);
